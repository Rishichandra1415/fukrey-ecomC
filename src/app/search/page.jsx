      ...
      <main className="flex-1">
        <div className="container mx-auto px-4 py-8 md:py-16">
          <div className="mb-8">
            ...
            <p className="mt-2 text-fukrey-gray-400">
          ...
          {filteredProducts.length > 0 ? (
            ...
            <div className="mt-12 text-center">
              <div className="mb-6 flex justify-center">
                <div className="flex h-20 w-20 items-center justify-center rounded-full bg-fukrey-gray-900 text-fukrey-gray-600">
              ...
              <p className="mt-2 text-fukrey-gray-400">Try checking your spelling or using more general terms.</p>
              <Link
                href="/"
